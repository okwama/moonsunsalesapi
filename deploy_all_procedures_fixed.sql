-- =====================================================
-- WOOSH DATABASE PROCEDURES DEPLOYMENT SCRIPT
-- Compatible with MariaDB and cPanel phpMyAdmin
-- =====================================================
...
BEGIN
    ...
    SELECT 
        ...
        jp.routeId,
        -- Client data (using underscore naming for compatibility)
        c.id as client_id,
        ...
        -- User data (using underscore naming for compatibility)
        u.id as user_id,
        u.name as user_name,
...
-- DEPLOYMENT COMPLETE
-- =====================================================
-- Both procedures have been created successfully
-- You can now use them in your NestJS application 